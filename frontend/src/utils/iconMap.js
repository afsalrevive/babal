...
import { AddOutline, RemoveOutline, HomeOutline, PeopleOutline, PersonAddOutline, SettingsOutline, DocumentOutline, PersonCircleOutline, MenuOutline, MenuSharp, KeyOutline, PencilOutline, TrashOutline, ChevronForwardOutline, ChevronDownOutline, LayersOutline, SwapHorizontalOutline, Ticket, SettingsSharp } from '@vicons/ionicons5';
export const iconMap = {
    ...
    services: markRaw(SettingsSharp), // Using SettingsSharp for ServiceManager
